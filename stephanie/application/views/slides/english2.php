...
<div class="menu">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tbody>
      <tr>
        <td><a href="/galeria/en" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','/assets/imagenes/galeria2.jpg',1)"><img src="/assets/imagenes/galeria<?=($segmento=='galeria')?"2":"1"?>.jpg" alt="" width="154" height="35" id="Image4"></a></td>
        <td><a href="/retratos/en" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','/assets/imagenes/retratos2.jpg',1)"><img src="/assets/imagenes/retratos<?=($segmento=='retratos')?"2":"1"?>.jpg" alt="" width="230" height="35" id="Image5"></a></td>
        <td><a href="/archivo/en" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','/assets/imagenes/archivo2.jpg',1)"><img src="/assets/imagenes/archivo<?=($segmento=='archivo')?"2":"1"?>.jpg" alt="" width="205" height="35" id="Image6"></a></td>
        <td><a href="/libro/en" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','/assets/imagenes/libro2.jpg',1)"><img src="/assets/imagenes/libro<?=($segmento=='libro')?"2":"1"?>.jpg" alt="" width="171" height="35" id="Image7"></a></td>
